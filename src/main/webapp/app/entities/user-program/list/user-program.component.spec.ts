...
describe('UserProgram Management Component', () => {
  let comp: UserProgramComponent;
  let fixture: ComponentFixture<UserProgramComponent>;
  let service: UserProgramService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'user-program', component: UserProgramComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(UserProgramComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.userPrograms?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
