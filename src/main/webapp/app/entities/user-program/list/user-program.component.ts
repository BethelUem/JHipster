...
export class UserProgramComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.userProgramService
      ...
      .subscribe({
        next: (res: HttpResponse<IUserProgram[]>) => {
  ...
  trackId(index: number, item: IUserProgram): number {
    return item.id!;
  }

  delete(userProgram: IUserProgram): void {
    const modalRef = this.modalService.open(UserProgramDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.userProgram = userProgram;
  ...
  protected onSuccess(data: IUserProgram[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
