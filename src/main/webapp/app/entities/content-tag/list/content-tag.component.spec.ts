...
describe('ContentTag Management Component', () => {
  let comp: ContentTagComponent;
  let fixture: ComponentFixture<ContentTagComponent>;
  let service: ContentTagService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'content-tag', component: ContentTagComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(ContentTagComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.contentTags?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
