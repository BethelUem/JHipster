...
export class ContentTagComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.contentTagService
      ...
      .subscribe({
        next: (res: HttpResponse<IContentTag[]>) => {
  ...
  trackId(index: number, item: IContentTag): number {
    return item.id!;
  }

  delete(contentTag: IContentTag): void {
    const modalRef = this.modalService.open(ContentTagDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.contentTag = contentTag;
  ...
  protected onSuccess(data: IContentTag[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
